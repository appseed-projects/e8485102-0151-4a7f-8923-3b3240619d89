...
- 👉 [Complete documentation](https://docs.appseed.us/products/flask-dashboards/black-dashboard) - `Learn how to use and update the product`
  - ✅ [Set up the environment](https://docs.appseed.us/products/flask-dashboards/black-dashboard#environment)
  - ✅ [Manage App users](https://docs.appseed.us/products/flask-dashboards/black-dashboard#manage-app-users)
  - ✅ [Application Bootstrap Flow](https://docs.appseed.us/products/flask-dashboards/black-dashboard#application-bootstrap-flow)
  - ✅ [UI Assets and Templates](https://docs.appseed.us/products/flask-dashboards/black-dashboard#ui-assets-and-templates)
  - ✅ [Set up the MySql Database](https://docs.appseed.us/products/flask-dashboards/black-dashboard#set-up-the-mysql-database)
  - ✅ [Static Assets for production](https://docs.appseed.us/products/flask-dashboards/black-dashboard#static-assets-for-production)  
  
<br />

> Built with [Black Dashboard Generator](https://appseed.us/generator/black-dashboard/)

- Timestamp: `2022-06-11 17:09`
- Build ID: `e8485102-0151-4a7f-8923-3b3240619d89`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e8485102-0151-4a7f-8923-3b3240619d89.git
$ cd e8485102-0151-4a7f-8923-3b3240619d89
```
